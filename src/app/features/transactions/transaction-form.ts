...
export class TransactionForm implements OnInit {
  ...
  protected async save(): Promise<void> {
    ...
    try {
      ...
      // The saved-confirmation moment (ux-blueprint §5): the list acknowledges the save with the
      // numbers already updated. Nav state only - presentation, nothing stored.
