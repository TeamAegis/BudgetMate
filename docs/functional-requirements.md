...
| FR-3.4 Savings-backed allowances (envelopes) | §4 Domain & Data Model, `docs/allowances.md`, ADR 0005 | Built (Rust reservation engine + schema + IPC, then the Angular Allowances screens - add/edit, pause/resume, delete, the savings-gate warning banner, and optional transaction tagging) |
